                ...
                <div class="header-left">
                    ...
                    <div class="dropdown for-message">
                        ...
                        <div class="dropdown-menu" aria-labelledby="message">
                            ...
                            <a class="dropdown-item media bg-flat-color-1" href="#">
                                <span class="photo media-left"><img alt="avatar" src="${userRef_url}/images/avatar/1.jpg"></span>
                            ...
                            <a class="dropdown-item media bg-flat-color-4" href="#">
                                <span class="photo media-left"><img alt="avatar" src="${userRef_url}/images/avatar/2.jpg"></span>
                                <span class="message media-body">
                            ...
                            <a class="dropdown-item media bg-flat-color-5" href="#">
                                <span class="photo media-left"><img alt="avatar" src="${userRef_url}/images/avatar/3.jpg"></span>
                                <span class="message media-body">
                            ...
                            <a class="dropdown-item media bg-flat-color-3" href="#">
                                <span class="photo media-left"><img alt="avatar" src="${userRef_url}/images/avatar/4.jpg"></span>
                                <span class="message media-body">
            ...
            <div class="col-sm-5">
                <div class="user-area dropdown float-right">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="user-avatar rounded-circle" src="${userRef_url}/images/admin.jpg" alt="User Avatar">
                    </a>
